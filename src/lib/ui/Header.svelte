<script lang="ts">
	import { click_outside } from './click_outsite';
...
<header class="fixed w-full z-10 top-0 min-h-12 flex items-center" class:bg-gray-100={scrollY > 76}>
	<div class="w-full leading-normal container inline-flex justify-between mx-auto">
		...
		<button
			...
			bind:this={navToggle}
			class="mobile-nav-toggle group block lg:hidden col-end-11 z-50"
		...
		<nav class="col-span-6 justify-end lg:flex lg:items-center items-end lg:items-end">
			<ul
